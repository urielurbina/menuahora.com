...
export default function Menu() {
  ...
  const categories = ['Todo', 'Tacos', 'Machetes', 'Bebidas', 'Postres']
  const products = [
    { 
      id: 1,
    ...
    { id: 4, name: 'Machete', price: 129.99, category: 'Machetes', image: '/images/machete.jpg' },
        ...
        <div className="lg:flex">
          ...
          <div className="bg-[#FF1C20] lg:w-1/4 lg:fixed lg:top-0 lg:left-0 lg:bottom-0 lg:overflow-y-auto">
            ...
            <div className="px-6 py-4 flex">
              ...
              <div className="w-1/3 flex justify-end items-center">
                <div className="flex space-x-2">
                  ...
                  <Link href="https://www.instagram.com/urielurbinadesign/" target="_blank" className="text-white">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="px-6 py-4 space-y-2">
              <Link 
                href="https://wa.link/nfcal7" 
                target="_blank" 
                className="w-full bg-black text-white hover:bg-gray-800 h-12 text-lg rounded-md flex items-center justify-center"
              >
              ...
              <Link 
                href="https://www.ubereats.com/mx-en"
                target="_blank"
                className="w-full bg-white text-black hover:bg-gray-100 h-12 text-lg rounded-md border border-black flex items-center justify-center"
              >
                Pedir en Uber Eats
              </Link>
              <Link 
            ...
            <div className="bg-gray-100">
              ...
              <div className={`px-6 py-4 ${isScrolled ? 'lg:mt-[100px]' : ''}`}>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  {products
                    .filter(product => activeCategory === 'Todo' || product.category === activeCategory)
                    .map((product) => (
                    <div 
                      key={product.id}
