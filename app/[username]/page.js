...
export default function UserPage({ params }) {
  ...
  const toggleProductDetails = useCallback((product) => {
    ...
    // Nota: Cambiamos de 'id' a '_id' para coincidir con el formato de MongoDB
  }, []);
...
<div role="status">
    <svg aria-hidden="true" class="w-8 h-8 text-gray-200 animate-spin dark:text-gray-400 fill-red-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
